...
We will install CKEditor 5 from source to give us maximum control over the application.
When built from create-react-app, CKEditor source build typicallly requires an eject. 
To get around this, we will use craco: hpmjs.com/package/@craco/craco
